...
describe('POST /todos', () => {
  it('should create a new todo', (done) => {
    ...
    request(app)
      ...
      // still need to test data really get stored
      .end((err, res) => {
        if (err) {
          return done(err);
        }
...
describe('GET /todos/:id', () => {
  ...
  it('should return 404 non-object ids', (done) => {
    request(app)
      .get(`/todos/${todos[0]._id.toHexString()}f`)
      .set('x-auth', users[0].tokens[0].token)
      .expect(404)
      .end(done);
  });
  ...
  it('should update the todo', (done) => {
    ...
    request(app)
      ...
      .expect((res) => {
        ...
        expect(res.body.todo.text).toBe('666666');
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    ...
    request(app)
      ...
      .expect((res) => {
        ...
        expect(res.body.todo.text).toBe('1111111')
